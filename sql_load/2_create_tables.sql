...
ALTER TABLE public.company_dim OWNER to admin;
ALTER TABLE public.skills_dim OWNER to admin;
ALTER TABLE public.job_postings_fact OWNER to admin;
ALTER TABLE public.skills_job_dim OWNER to admin;
